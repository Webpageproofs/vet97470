...
$(document).ready(function () {
	...
	// куки
		...
		$(".cookies__btn").click(function () {
			...
			$("#cookies").removeClass('cookies-show').addClass('cookies-hide').fadeOut();
			...
			{
			setTimeout(function(){
			$("#cookies").addClass('cookies-show').removeClass('cookies-hide');
			}, 4000)
			}
			else { $("#cookies").removeClass('cookies-show').addClass('cookies-hide').hide();
			}
